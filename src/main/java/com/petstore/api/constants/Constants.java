...
public class Constants {
    ...
    public static final String PATH_TO_TEST_DATA_EXCEL_SHEET = "TestDataForPetStoreDemo.xls";
//    public static final String PATH_TO_TEST_DATA_EXCEL_SHEET = PROJECT_PATH + "/src/test/resources/TestDataForPetStoreDemo.xls";
